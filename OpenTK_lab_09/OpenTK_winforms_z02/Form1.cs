...
namespace OpenTK_winforms_z02
{
    public class LightSource
    {
        ...
        public LightSource(float x, float y, float z)
        {
            ...
            Specular[0] = 0.1f; Specular[1] = 0.1f; Specular[2] = 0.1f; Specular[3] = 1.0f;
            Enabled = false;
        }
    ...
    public partial class Form1 : Form
    {
        ...
        private void GlControl1_MouseMove(object sender, MouseEventArgs e) {
            ...
            if (lightON && lightON_1 && statusMouseDown)
            {
                float dx = e.X - lastMousePos.X;
                float dy = e.Y - lastMousePos.Y;
                light1.MoveByMouse(dx, dy);
        ...
        private void GlControl1_Paint(object sender, PaintEventArgs e) {
            ...
            GL.Light(LightName.Light1, LightParameter.Ambient, light1.Ambient);
            GL.Light(LightName.Light1, LightParameter.Diffuse, light1.Diffuse);
            GL.Light(LightName.Light1, LightParameter.Specular, light1.Specular);
            GL.Light(LightName.Light1, LightParameter.Position, light1.Position);
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            if (lightON && lightON_1)
            {
                switch (e.KeyCode)
                {
                    case Keys.Up: light1.Move(0, 1, 0); break;   
                    case Keys.Down: light1.Move(0, -1, 0); break;  
                    case Keys.Left: light1.Move(-1, 0, 0); break;   
                    case Keys.Right: light1.Move(1, 0, 0); break;    
                    case Keys.PageUp: light1.Move(0, 0, 1); break; 
                    case Keys.PageDown: light1.Move(0, 0, -1); break;
                }
                GlControl1.Invalidate();
            }
        }
